...
**Less narrow view, not static, more temporal**
...
```{r figure-2, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Map of route 1A."}
...
```{r figure-3, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 2 of route 1A depicting two or three lanes in each direction and no cycling facilities on the roadway. Lighting and natural views are present. (Source: Google Street View)"}
knitr::include_graphics('Figure 3.png')
```

```{r figure-4, echo=FALSE, fig.align = 'center', out.width = "65%", fig.cap = "Segment 2 of route 1A depicting the uphill section on a 2 lane arterial road with no on-street cycling infrastructure. (Source: Google Street View)"}
...
```{r figure-5, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 4 of route 1A depicting the urban design of the street when making a left turn to follow the City's signed bicycle route. (Source: Google Street View)"}
...
```{r figure-6, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 9 of route 1A depicting the on-street marked bicycle lane in a residential neighbourhood. (Source: Google Street View)"}
knitr::include_graphics('Figure 6.png')
```

```{r figure-7, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 13 of Route 1A depicting a pedestrian-activated signal to cross a an arterial road. (Source: Google Street View)"}
knitr::include_graphics('Figure 7.png')
```

#### Route 1B

```{r figure-8, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Map of route 1B."}
...
```{r figure-9, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 4 of route 1B depicting the streetscape on a signed route in a residential area. (Source: Google Street View)"}
...
```{r figure-10, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Map of route 2A."}
...
```{r figure-11, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 5 on route 2A depicting an on-street marked bicycle lane on a one-way street with one lane going westward. (Source: Google Street View)"}
knitr::include_graphics('Figure 11.png')
```

```{r figure-12, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 18 of route 2A depicting the off-street multi-use path called the Hamilton Brantford Rail Trail. (Source: Google Street View)"}
...
```{r figure-13, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 8 of route 2A depicting the buffered bicycle lane ending and the transition that a cyclist would have to make to get into the left-turn lane. (Source: Google Street View)"}
...
```{r figure-14, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 14 of route 2A depicting an arterial road without on-street cycling infrastructure. (Source: Google Street View)"}
knitr::include_graphics('Figure 14.png')
```

```{r figure-15, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 14 of route 2A depicting a signalized intersection where a cyclist would turn left on to a street with sharrows to travel to the Hamilton-Brantford Rail Trail. (Source: Google Street View)"}
knitr::include_graphics('Figure 14.1.png')
```
...
```{r figure-16, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 29 of route 2A depicting the intersection of a residential road and two arterial roads. (Source: Google Street View)"}
knitr::include_graphics('Figure 15.png')
```

#### Route 2B

```{r figure-17, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Map of route 2B."}
...
```{r figure-18, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 11 of route 2B depicting a residential area. (Source: Google Street View)"}
knitr::include_graphics('Figure 17.png')
```

```{r figure-19, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 30 of route 2B depicting the protected multi-use trail on the right side of the roadway on an arterial road over the Red Hill Valley Parkway. (Source: Google Street View)"}
...
```{r figure-20, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 14 on route 2B depicting a two-lane arterial road with on-street parking. (Source: Google Street View)"}
knitr::include_graphics('Figure 19.png')
```
```{r figure-21, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 20 on route 2B depicting a two-lane arterial road with no on-street parking and a wide grassy verge on the right side of the roadway. (Source: Google Street View)"}
knitr::include_graphics('Figure 20.png')
```

```{r figure-22, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 31 of route 2B depicting a lane change from the far right side of the roadway to the left-turn lane on a four-lane arterial road. (Source: Google Street View)"}
...
```{r figure-23, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Map of route 3A."}
...
```{r figure-24, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 2 of route 3A depicting a residential street. (Source: Google Street View)"}
knitr::include_graphics('Figure 23.png')
```

```{r figure-25, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 13 of route 3A depicting a two-lane arterial road without cycling facilities in a residential area. (Source: Google Street View)"}
knitr::include_graphics('Figure 24.png')
```

```{r figure-26, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 15 of route 3A depicting a two-lane arterial road without cycling facilities or a sidewalk leading to a more industrial area. (Source: Google Street View)"}
...
```{r figure-27, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Map of route 3B."}
...
```{r figure-28, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 4 on route 3B with a buffered on-street bicycle lane on a one-way street. (Source: Google Street View)"}
...
```{r figure-29, echo=FALSE, fig.align = 'center', out.width = "65%", fig.pos = "!H", fig.cap = "Segment 8 on route 3B depicting a two-way cycle track on a one-way arterial road. (Source: Google Street View)"}
